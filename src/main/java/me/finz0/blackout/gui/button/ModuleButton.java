package me.finz0.blackout.gui.button;
...
public class ModuleButton implements IGuiComponent {
    ...
    public ModuleButton(Module module, int x, int y, Panel panel) {
        ...
        int subButtonY = 0;
        for(Setting s : Blackout.getInstance().settingManager.getSettingsForMod(module)){
    ...
    private int getColor(int mouseX, int mouseY){
        Color color = module.isEnabled() ? Blackout.getInstance().clientSettings.getColorr(200) : new Color(50, 50, 50, 200);
