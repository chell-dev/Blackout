...
public class HudComponent<T extends Module> {
    ...
    public void render() {
        if(Wrapper.getPlayer() != null) {
            int screenWidth = Blackout.getInstance().resolution.getScaledWidth();
            int screenHeight = Blackout.getInstance().resolution.getScaledHeight();
